...
export default function TechCard({
  ...
  return (
    <div className="group relative p-4 flex items-center justify-center hover:scale-105 transition-transform duration-300  bg-violet-500 bg-opacity-20 rounded-md overflow-hidden">
