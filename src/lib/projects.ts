export const projects = [
  ...
  },
  {
    name: "BNAS",
    description:
      "An online real estate web application that connects buyers and sellers of properties. It is a platform that allows users to search for properties, view property details, and contact the seller for more information.",
    image: "/project-images/bnas.png",
    links: {
      github: "https://github.com/iambasilp/team-estate",
    },
  },
  {
