export const skills = [
  ...
  {
    name: "Express.js",
    icon: "/icons/express-js-icon.png",
    description:
      "Express.js is a web application framework for Node.js designed for building APIs and web apps.",
